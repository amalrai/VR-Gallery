...
namespace yoyohan
{
    ...
    public class DownloadObj
    {
        ...
        public XMLType currentDownloadType;
        public DownloadState currentDownloadState;
        public DownloadCategory currentDownloadCategory;
        ...
        public DownloadObj ChangeDownloadCategory(DownloadCategory category)
        {
            this.currentDownloadCategory = category;
            return this;
        }
