...
// Four parameters
static public class Messenger<T, U, V, B>
{
    static public void AddListener(string eventType, Action<T, U, V, B> handler)
    {
        MessengerInternal.AddListener(eventType, handler);
    }

    static public void AddListener<TReturn>(string eventType, Func<T, U, V, B, TReturn> handler)
    {
        MessengerInternal.AddListener(eventType, handler);
    }

    static public void RemoveListener(string eventType, Action<T, U, V, B> handler)
    {
        MessengerInternal.RemoveListener(eventType, handler);
    }

    static public void RemoveListener<TReturn>(string eventType, Func<T, U, V, B, TReturn> handler)
    {
        MessengerInternal.RemoveListener(eventType, handler);
    }

    static public void Broadcast(string eventType, T arg1, U arg2, V arg3, B arg4)
    {
        Broadcast(eventType, arg1, arg2, arg3, arg4, MessengerInternal.DEFAULT_MODE);
    }

    static public void Broadcast<TReturn>(string eventType, T arg1, U arg2, V arg3, B arg4, Action<TReturn> returnCall)
    {
        Broadcast(eventType, arg1, arg2, arg3, arg4, returnCall, MessengerInternal.DEFAULT_MODE);
    }

    static public void Broadcast(string eventType, T arg1, U arg2, V arg3, B arg4, MessengerMode mode)
    {
        MessengerInternal.OnBroadcasting(eventType, mode);
        var invocationList = MessengerInternal.GetInvocationList<Action<T, U, V,B>>(eventType);

        foreach (var callback in invocationList)
            callback.Invoke(arg1, arg2, arg3, arg4);
    }

    static public void Broadcast<TReturn>(string eventType, T arg1, U arg2, V arg3, B arg4, Action<TReturn> returnCall, MessengerMode mode)
    {
        MessengerInternal.OnBroadcasting(eventType, mode);
        var invocationList = MessengerInternal.GetInvocationList<Func<T, U, V, B, TReturn>>(eventType);

        foreach (var result in invocationList.Select(del => del.Invoke(arg1, arg2, arg3, arg4)).Cast<TReturn>())
        {
            returnCall.Invoke(result);
        }
    }
...
static public class Messenger<T, U, V, B,I>
{
    static public void AddListener(string eventType, Action<T, U, V, B, I> handler)
    {
        MessengerInternal.AddListener(eventType, handler);
    }

    static public void AddListener<TReturn>(string eventType, Func<T, U, V, B, I, TReturn> handler)
    {
        MessengerInternal.AddListener(eventType, handler);
    }

    static public void RemoveListener(string eventType, Action<T, U, V, B, I> handler)
    {
        MessengerInternal.RemoveListener(eventType, handler);
    }

    static public void RemoveListener<TReturn>(string eventType, Func<T, U, V, B, I, TReturn> handler)
    {
        MessengerInternal.RemoveListener(eventType, handler);
    }

    static public void Broadcast(string eventType, T arg1, U arg2, V arg3, B arg4,I arg5)
    {
        Broadcast(eventType, arg1, arg2, arg3, arg4, arg5, MessengerInternal.DEFAULT_MODE);
    }

    static public void Broadcast<TReturn>(string eventType, T arg1, U arg2, V arg3, B arg4, I arg5, Action<TReturn> returnCall)
    {
        Broadcast(eventType, arg1, arg2, arg3, arg4, arg5, returnCall, MessengerInternal.DEFAULT_MODE);
    }

    static public void Broadcast(string eventType, T arg1, U arg2, V arg3, B arg4, I arg5, MessengerMode mode)
    {
        MessengerInternal.OnBroadcasting(eventType, mode);
        var invocationList = MessengerInternal.GetInvocationList<Action<T, U, V, B,I>>(eventType);

        foreach (var callback in invocationList)
            callback.Invoke(arg1, arg2, arg3, arg4, arg5);
    }

    static public void Broadcast<TReturn>(string eventType, T arg1, U arg2, V arg3, B arg4, I arg5, Action<TReturn> returnCall, MessengerMode mode)
    {
        MessengerInternal.OnBroadcasting(eventType, mode);
        var invocationList = MessengerInternal.GetInvocationList<Func<T, U, V, B,I, TReturn>>(eventType);

        foreach (var result in invocationList.Select(del => del.Invoke(arg1, arg2, arg3, arg4, arg5)).Cast<TReturn>())
        {
            returnCall.Invoke(result);
        }
    }
