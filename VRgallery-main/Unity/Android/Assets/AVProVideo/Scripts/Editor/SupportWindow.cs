	...
	public class SupportWindow : EditorWindow
	{
		...
		void OnGUI()
		{
			...
			if (_selectionIndex == 1)
			{
				...
				{
					CustomUrlOpener.Open(MediaPlayerEditor.LinkUserManual);
				}
				GUI.color = Color.white;
				GUILayout.FlexibleSpace();
				GUILayout.EndHorizontal();
				...
				{
					CustomUrlOpener.Open(MediaPlayerEditor.LinkGithubIssues);
				}
				GUI.color = Color.white;
				GUILayout.FlexibleSpace();
				GUILayout.EndHorizontal();
				...
				{
					CustomUrlOpener.Open(MediaPlayerEditor.LinkScriptingClassReference);
				}
				GUI.color = Color.white;
				GUILayout.FlexibleSpace();
				GUILayout.EndHorizontal();
				...
				{
					CustomUrlOpener.Open(MediaPlayerEditor.LinkPluginWebsite);
				}
				GUI.color = Color.white;
				GUILayout.FlexibleSpace();
				GUILayout.EndHorizontal();
				...
				{
					CustomUrlOpener.Open(MediaPlayerEditor.LinkForumPage);
				}
				GUI.color = Color.white;
				GUILayout.FlexibleSpace();
				GUILayout.EndHorizontal();
