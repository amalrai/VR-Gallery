...
namespace yoyohan.DownloadToolDemo
{
    public class DownloadToolDemo : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            //1.第一步启动下载器
            UnityDownloadMgr.instance.DownloaderInitialize();
        ...
        void DownloadOne()
        {
            //string url1 = "http://111.231.111.69:8088/DownLoad/AssetBundles/Courseware/aquion_activation_yzq/aquion_activation_yzq_device.model";
            string url1 = "https://yoyohan1.gitee.io/logo.ico";
            string url2 = "http://111.231.111.69:8088/DownLoad/AssetBundles/Courseware/aquion_activation_yzq/aquion_activation_yzq_displayscreen_cn.texture";
            ...
            DownloadObj obj1 = UnityDownloadMgr.instance.GetDownloadObjByID("1");
            DownloadObj obj2 = UnityDownloadMgr.instance.GetDownloadObjByID("2");

            if (obj1 == null)
            {
                string parentPath = Environment.CurrentDirectory + "\\下载Data";
                obj1 = new DownloadObj().SetID("1").SetUrl(url1).SetParentPath(parentPath).SetFileName("aquion_activation_yzq_device.model");
            }

            if (obj2 == null)
            {
                string parentPath = Environment.CurrentDirectory + "\\下载Data";
                obj2 = new DownloadObj().SetID("2").SetUrl(url2).SetParentPath(parentPath).SetFileName("aquion_activation_yzq_displayscreen_cn.texture");
            }

            UnityDownloadMgr.instance.StartDownloadOne(obj1);
            UnityDownloadMgr.instance.StartDownloadOne(obj2);
