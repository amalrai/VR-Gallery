...
import org.jeecg.common.system.util.MessageCacheUtil;
...
public class JeecgController<T, S extends IService<T>> {
    ...
    protected ModelAndView exportXls(HttpServletRequest request, T object, Class<T> clazz, String title) {
        ...
        ExportParams  exportParams=new ExportParams(title +"-"+ MessageCacheUtil.getMessage("报表", UserLocalContext.getLocal()), MessageCacheUtil.getMessage("导出人", UserLocalContext.getLocal()) + ":" + sysUser.getRealname(), title);
