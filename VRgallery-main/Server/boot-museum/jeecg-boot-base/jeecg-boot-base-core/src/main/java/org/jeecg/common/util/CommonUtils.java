...
public class CommonUtils {
   ...
   //中文正则
    ...
    public static String uploadOnlineImage(byte[] data,String basePath,String bizPath,String uploadType){
        ...
        try {
            if(CommonConstant.UPLOAD_TYPE_LOCAL.equals(uploadType)){
                ...
                }else if(CommonConstant.UPLOAD_TYPE_AWS.equals(uploadType)){
                    dbPath = AwsUtil.uploadToS3ByInput(in, relativePath);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
     ...
     */
    public static String upload(MultipartFile file, String bizPath, String uploadType, boolean isEncode) {
        String url = "";
        if(CommonConstant.UPLOAD_TYPE_MINIO.equals(uploadType)){
            ...
            url = AwsUtil.upload(file,bizPath, isEncode);
        }
        return url;
    }
    /**
