<template>
  <div class="user-wrapper" :class="theme">
    ...
    <component :is="searchMenuComp" v-show="searchMenuVisible || isMobile()" class="borders" :visible="searchMenuVisible" :title="this.$t('搜索菜单')" :footer="null" @cancel="searchMenuVisible=false">
      <a-select
        class="search-input"
        showSearch
        :showArrow="false"
        :placeholder="this.$t('搜索菜单')"
...
<!--    <header-notice class="action"/>-->
    <a-dropdown>
      <span class="action action-full ant-dropdown-link user-dropdown-menu">
        ...
        <span v-if="isDesktop()">{{$t('欢迎您')}},{{ nickname() }}</span>
      </span>
