...
<!--            <img src="~@/assets/logo.svg" class="logo" alt="logo">-->
            <span class="title">{{ $t('sys.name')}}</span>
          </a>
        </div>
<!--        <div class="desc">-->
...
<!--        </div>-->
      ...
      <div class="top-right">
        <a-list-item>
          <a-list-item-meta>
            <div slot="title" style="margin-right: 5px">{{ $t('lang.option')}}</div>
          </a-list-item-meta>
          <a-select size="small" style="width: 80px;" :defaultValue="currentLang" @change="handleLanguageChange">
...
<script>
  ...
  export default {
    ...
    created() {
      this.currentLang = String(this.$ls.get('language', 'ja-JP'));
    },
    mounted () {
