...
import JUploadNew from './JUploadNew.vue'
...
import JImageUploadNew from './JImageUploadNew.vue'
...
export default {
  install(Vue) {
    ...
    Vue.component('JImageUploadNew', JImageUploadNew)
    ...
    Vue.component('JUploadNew', JUploadNew)
    //jeecgbiz
